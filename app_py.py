...
Original file is located at
    https://colab.research.google.com/drive/10BOO8ce_gyegCJt-ZonHPyqnRr_pySbF
"""
...
!pip install streamlit torch torchvision opencv-python pillow gtts speechrecognition google-generativeai
